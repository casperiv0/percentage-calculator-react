...
export function CalculatePercentageSection() {
  ...
  function onSubmit(event: React.FormEvent) {
    ...
    const answer = (amount1 / 100) * amount2;

    setAnswer(answer.toString());
  }

  return (
    <Box component="section" margin="20px auto" maxWidth={750}>
      <Typography variant="h4">Calculate Amount from percentage</Typography>
